...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 3 :
        ...
        if sys.argv[2] == 'Y':
            ...
            DB.create_table_embeddings(cursor)
    ...
    for chunk in chunks:
        ...
        DB.insert_embedding(text,source, embedding_vector, page_number, detected_language,cursor)
        
        # Ottieni l'id del record appena inserito
        record_id = cursor.fetchone()[0]
        
        # Aggiorna il campo tsv_content solo per il record appena inserito
        DB.set_tsv(cursor,detected_language,record_id)
